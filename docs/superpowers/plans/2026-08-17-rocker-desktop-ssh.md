...
- [x] **Step 3: Remove old project files and create the minimal Electron/Vite scaffold**
...
- [x] **Step 5: Commit the scaffold replacement**
...
- [x] **Step 1: Write failing tests for host normalization and credential boundaries**
...
- [x] **Step 3: Implement storage and OpenSSH config parsing**
...
- [x] **Step 5: Commit storage contracts**
...
- [x] **Step 3: Implement host-key verification and SSH manager**
...
- [x] **Step 1: Write failing parser and forwarding tests**
...
- [x] **Step 3: Implement fixed remote probes and forwarding**
...
- [x] **Step 5: Commit port and monitoring services**
...
- [x] **Step 1: Write failing renderer and i18n tests**
...
- [x] **Step 4: Run renderer tests, build, and type checks**
...
- [x] **Step 5: Commit the renderer shell**
...
- [x] **Step 1: Write failing host and tab state tests**
...
- [x] **Step 3: Implement host list/editor and history**
...
- [x] **Step 4: Implement xterm.js session tabs**
...
- [x] **Step 5: Run focused tests, build, and type checks**
...
- [x] **Step 6: Commit hosts and terminal tabs**
...
- [x] **Step 1: Write failing ports and monitor state tests**
...
- [x] **Step 3: Implement the Ports view**
...
- [x] **Step 4: Implement the current-host monitor and settings**
...
- [x] **Step 5: Implement SFTP and Snippets placeholders**
...
- [x] **Step 6: Run focused tests, build, and type checks**
...
- [x] **Step 7: Commit ports and supporting views**
...
- [x] **Step 1: Write a packaging metadata test**
...
- [x] **Step 3: Configure package targets and original icon**
...
- [x] **Step 4: Document development and platform build commands**
...
- [x] **Step 5: Run packaging metadata and all static checks**

Run: `npm test -- --run tests/packaging.test.ts && npm run typecheck && npm run build`

Expected: PASS.

- [x] **Step 6: Commit packaging and docs**
...
- [x] **Step 2: Run Electron smoke verification**
...
- [x] **Step 3: Run the production packaging commands available on the current host**
...
- [x] **Step 5: Commit verification fixes and update the plan**
...
Verification record: the complete Vitest suite (18 files, 39 tests), TypeScript typecheck, and electron-vite production build pass on Linux. `electron-builder` loads the Windows/macOS configuration but native installer generation is platform-only here because `cpu-features` cannot be cross-compiled by node-gyp on Linux; the committed Windows and macOS GitHub Actions jobs run packaging on their native runners.
