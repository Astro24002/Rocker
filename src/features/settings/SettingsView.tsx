  ...
  return (
    <section className="settings-view">
      ...
      <div className="settings-list">
        ...
        <SettingRow title={t("settings.terminalFont")} description={t("settings.terminalFontHint")}><select disabled={terminalAppearanceDisabled} aria-label={t("settings.terminalFont")} value={settings.terminalFont} onChange={(event) => { if (!terminalAppearanceDisabled) onUpdate({ terminalFont: event.target.value }) }}><option value="JetBrains Mono">{t("settings.fontJetBrainsMono")}</option><option value="SFMono-Regular">{t("settings.fontSFMono")}</option><option value="Consolas">{t("settings.fontConsolas")}</option></select></SettingRow>
